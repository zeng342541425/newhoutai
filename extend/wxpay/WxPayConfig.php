...
class WxPayConfig
{
     ...
     * @var string
     */
    const APPID = 'wx6de70227f98c29a5';//您的app
    const MCHID = '1252484701';//mchid
    const KEY = 'GrtlWMLxCBxOmprwRvCTvqhxlVgAFEd8';//您的key
    const APPSECRET = '70a9879c6bd845423a4efc54f3c87eba';//微信密钥
    const NOTIFY_URL = 'http://wx.huidait.cn/admin/wxpay/notify';
